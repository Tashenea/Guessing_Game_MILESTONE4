...
void BinaryTree::begin(BinaryTreeNode* tree)
{
	...
	if (/*tree->leftChild != NULL*/ tree->leftChild != 0)
	{
...
void Instructions()
{
	...
	cout << "1. Player 1 and Player 2 one is a thinker and the other is a guesser";
	cout << "2. The Thinker is the player who thinks of a person, place or thing.";
	cout << "3. The Guesser is the player who guesses what the thinker is thinking by asking yes or no questions";
	cout << "4. The game will continue until the guesser gives up or finds the answer.";
	IgnoreLine();
}
